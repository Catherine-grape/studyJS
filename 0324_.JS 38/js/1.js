...
let arr2 = [100, 200, 300, 400];
let res4 = arr2.mySome((item, index) => {
    return item > 200;
})
...
let arr2 = [100, 200, 300, 400];
let res4 = arr2.myEvery((item, index) => {
    return item > 200;
})
...
let arr2 = [100, 200, 300, 400];
let res4 = arr2.myForEach((item, index) => { });
...
let arr2 = [100, 200, 300, 400];
let res4 = arr2.myMap((item, index) => { return 100 })
...
let arr2 = [100, 200, 300, 400];
let res4 = arr2.myfilter((item, index) => { return item>100})